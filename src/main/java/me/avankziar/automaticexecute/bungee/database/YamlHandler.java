...
public class YamlHandler
{
	...
	private Configuration aum = null;
	...
	public boolean mkdirGeneralFiles()
	{
	    ...
	    File automaticexecute = new File(plugin.getDataFolder(), "automaticexecute.yml");  
	...
	private boolean loadGeneralFiles()
	{
		...
		try 
		{
			aum = ConfigurationProvider.getProvider(YamlConfiguration.class)
					.load(new File(plugin.getDataFolder(), "automaticexecute.yml"));
		} catch (IOException e) 
		{
			e.printStackTrace();
			return false;
