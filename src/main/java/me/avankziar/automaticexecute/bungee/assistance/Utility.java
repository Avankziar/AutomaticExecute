...
public class Utility
{
	...
	{
		setPrefix(plugin.getYamlHandler().get().getString("Prefix", "&7[&eCopyCat&7] &r"));
		return true;
	}
	...
	public static String getUUIDFromName(String name)
	{
		...
		try
		{
            ...
            uuid = uuidraw.substring(0,9)+"-"+uuidraw.substring(9,13)+"-"+uuidraw.substring(13,17)+"-"+uuidraw.substring(17,21)+"-"+uuidraw.substring(21);
			in.close();
		}
		catch (Exception e)
		{
