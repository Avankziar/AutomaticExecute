...
public class YamlHandler
{
	...
	public boolean mkdirConfig()
	{
		...
		if(!automaticexecute.exists()) 
		{
			...
			plugin.saveResource("automaticexecute.yml", false);
		}
		return true;
	}
	...
	private boolean loadGeneralFiles()
	{
		...
		if(!loadYamlTask(automaticexecute, aum, "automaticexecute.yml"))
		{
			return false;
		}
		return true;
	...
	private boolean mkdir()
	{
		...
		if(!arabic.exists()) 
		{
			AutomaticExecute.log.info("Create arabic.yml...");
			try
			{
		...
		if(!dutch.exists()) 
		{
			AutomaticExecute.log.info("Create dutch.yml...");
			try
			{
		...
		if(!english.exists()) 
		{
			AutomaticExecute.log.info("Create english.yml...");
			try
			{
		...
		if(!french.exists())
		{
			AutomaticExecute.log.info("Create french.yml...");
			try
			{
		...
		if(!german.exists()) 
		{
			AutomaticExecute.log.info("Create german.yml...");
			try
			{
		...
		if(!hindi.exists()) 
		{
			AutomaticExecute.log.info("Create hindi.yml...");
			try
			{
		...
		if(!italian.exists()) 
		{
			AutomaticExecute.log.info("Create italian.yml...");
			try
			{
		...
		if(!japanese.exists()) 
		{
			AutomaticExecute.log.info("Create japanese.yml...");
			try
			{
		...
		if(!mandarin.exists()) 
		{
			AutomaticExecute.log.info("Create mandarin.yml...");
			try
			{
		...
		if(!russian.exists()) 
		{
			AutomaticExecute.log.info("Create russian.yml...");
			try
			{
		...
		if(!spanish.exists()) 
		{
			AutomaticExecute.log.info("Create spanish.yml...");
			try
			{
